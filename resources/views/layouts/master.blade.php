    ...
    <style>
       ...
       /* Add this to your CSS file */
        ...
        .dark-mode {
            ...
            background-color: #333; /* Change this to your dark background color */
            color: #fff; /* Change this to your dark text color */
        }

        .text-dark {
            /* Add styles for dark text here */
            color: #333 !important; /* Change this to your dark text color */
        }

        .text-light {
            /* Add styles for light text here */
            color: #fff !important; /* Change this to your light text color */
        }
