...
<head>
    ...
    <style>
        ...
        body {
            margin: 0;
            overflow: hidden;
            background-image: url('images/auth_image.png');
        ...
        body::before {
            ...
            /* Adjust the alpha value for the desired level of dimming */
            pointer-events: none;
            /* Allows clicks to pass through the overlay to the elements underneath */
        }
    </style>
</head>
                                                            ...
                                                            <div class="col-md-12 text-center">
                                                                <p class="mb-0">
                                                                    <a href="{{ route('register') }}"
                                                                        class="text-sm text-gray-700 dark:text-gray-500 underline mr-3">Register</a>
                                                                </p>
                                                            </div>
