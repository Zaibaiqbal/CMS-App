          ...
          <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <select name="{{$name}}" id="" class="form-control fstdropdown-select" onchange="getAccountInfo(event,this)" @if($transaction->client_group== 'Cash Account') disabled @else class="form-control fstdropdown-select" @endif>
